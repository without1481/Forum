...
class vB5_Frontend_Controller_Search extends vB5_Frontend_Controller
{
	...
	function actionResult()
	{
		...
		elseif ($requirehv)
		{
			//temporary to make recaptcha1.0 work properly.
			if (!empty($serverData['recaptcha_challenge_field']))
			{
				$serverData['humanverify']['recaptcha_challenge_field'] = $serverData['recaptcha_challenge_field'];
				$serverData['humanverify']['recaptcha_response_field'] = $serverData['recaptcha_response_field'];
				unset($serverData['recaptcha_challenge_field']);
				unset($serverData['recaptcha_response_field']);
			}
