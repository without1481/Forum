 ...
 * @version $Revision: 94017 $
 * @since $Date: 2017-05-12 10:52:27 -0700 (Fri, 12 May 2017) $
...
class vB_Friendly_Url_Forumhome extends vB_Friendly_Url_GenerationOnly
{
	...
	)
	{
		...
		$this->script = vB5_Route::buildUrl($forumHome['routeid'] . '|fullurl');
