...
*
* @package 		vBulletin
* @version		$Revision: 95075 $
* @date 		$Date: 2017-08-24 15:35:29 -0700 (Thu, 24 Aug 2017) $
*
*/
class vB_Text_Diff
{
	...
	*/
	function __construct($data_old, $data_new, $output_progress = false)
	{
		...
		//need to trim the last newline (if it exists) because otherwise we get a phantom blank
		//line when we do the split below.
		$data_old = preg_replace('#\r?\n$#D', '', $data_old);
		$data_new = preg_replace('#\r?\n$#D', '', $data_new);
