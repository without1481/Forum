...
function xml_import_settings($xml = false)
{
	...
	foreach($arr['settinggroup'] AS $group)
	{
		...
		if (!defined('UPGRADE_COMPAT'))
		{
			$fieldsArray = array('varname', 'grouptitle', 'value', 'defaultvalue', 'datatype', 'optioncode', 'displayorder', 'advanced', 'volatile', 'validationcode', 'blacklist', 'product', 'ispublic', 'adminperm');
		}
		else
		{
			$fieldsArray = array('varname', 'grouptitle', 'value', 'defaultvalue', 'datatype', 'optioncode', 'displayorder', 'advanced', 'volatile', 'ispublic', 'adminperm');
		}
		/*insert query*/
