...
$config['Database']['technicalemail'] = 'cto@freegame2017.com';
...
$config['UserCenter']['client_id'] = 'forums.freegame2017.com';
$config['UserCenter']['login_temp'] = 'iframe';
$config['UserCenter']['enable'] = TRUE;
$config['UserCenter']['api_url'] = 'http://user.localhost.com/index.php/auth';
$config['UserCenter']['secret'] = '2496A65497AF70CC506A72F133BBCF56';
$config['UserCenter']['app_id'] = 170000;
$config['UserCenter']['time_limit'] = 1200;
$config['UserCenter']['forgetPasswordUrl'] = 'http://user.localhost.com/user/forget_pw?app_id=170000&callback_url=http://forums.localhost.com';
$config['UserCenter']['platform_name'] = 'FG';
 

/*======================================================================*\
|| ####################################################################
|| # CVS: $RCSfile$ - $Revision: 79896 $
|| ####################################################################
\*======================================================================*/
