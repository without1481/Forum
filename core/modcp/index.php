...
define('CVS_REVISION', '$RCSfile$ - $Revision: 92453 $');
...
if ($_REQUEST['do'] == 'nav')
{
	...
	vB::getDatastore()->getValue('options');

	$vboptions = vB::getDatastore()->getValue('options');
	$logourl = $vboptions['bburl'] . '/cpstyles/' . $vboptions['cpstylefolder'] . '/cp_logo.' . $vboptions['cpstyleimageext'];
	?>
<div>
<img src="<?php echo $logourl; ?>" alt="" border="0" hspace="4" vspace="4" />
	<?php
	...
	{
		construct_nav_option($vbphrase['post_new_announcement_gcphome'], 'announcement.php?do=add','modcp');
		construct_nav_option($vbphrase['forum_manager_gcphome'], 'forum.php?do=modify','modcp');
	...
	{
		construct_nav_option($vbphrase['join_requests'], 'user.php?do=viewjoinrequests','modcp');
