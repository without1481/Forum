...
define('CVS_REVISION', '$RCSfile$ - $Revision: 95663 $');
...
if ($_POST['do'] == 'update')
{
	...
	*/
	...
	$ug_bitfield['forumpermissions']['canreply'] = $ugpermissions['socialgrouppermissions']['canpostmessage'];
