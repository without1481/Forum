...
define('CVS_REVISION', '$RCSfile$ - $Revision: 93454 $');
...
$cssimgurl = "" .$vbulletin->options['frontendurl'] . '/' . vB_Template_Runtime::fetchStyleVar('imgdir_spriteiconsvb') . '/sprite_icons_vb_' . vB_Template_Runtime::fetchStyleVar('textdirection') . ".png";
...
if ($_REQUEST['do'] == 'contentlist')
{
	...
	foreach (array("Text", "Poll", "Gallery", "Link", "Video", "Event") AS $class)
	{
...
if ($_REQUEST['do'] == 'nodeaction')
{
	...
	//correctly (passed as array('do' => 'something&page=1&perpage=25') which is a single parameter.
