...
define('CVS_REVISION', '$RCSfile$ - $Revision: 93458 $');
...
if ($_REQUEST['do'] == 'edit')
{
	...
	print_form_header('admincp/attachmentpermission', 'doupdate');
...
if ($_REQUEST['do'] == 'modify')
{
	...
	foreach ($attachments as $attach)
	{
		...
		echo "$indent<li><b><a name=\"a_$extension\" href=\"admincp/attachment.php?" . vB::getCurrentSession()->get('sessionurl') . "do=updatetype&amp;extension=$extension\">$extension</a></b>";
...
if ($_REQUEST['do'] == 'quickset')
{
	...
	$attachment_type = vB::getDbAssertor()->getRow('vBForum:attachmenttype', array('extension' => $vbulletin->GPC['extension']));
