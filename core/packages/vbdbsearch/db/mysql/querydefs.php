 ...
 *
 * @package vBulletin
 * @version $Revision: 96074 $
 * @since $Date: 2017-11-08 16:09:06 -0800 (Wed, 08 Nov 2017) $
...
class vBDBSearch_dB_MYSQL_QueryDefs extends vB_dB_MYSQL_QueryDefs
{
	...
	private function doStarterJoin($skipChannels = false)
	{
		/*
		...
		if ($skipChannels)
		{
			...
			$this->join['starter'] = "LEFT JOIN " . TABLE_PREFIX . "node AS starter " .
