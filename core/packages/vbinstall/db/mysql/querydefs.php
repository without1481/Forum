...
*
* @package vBulletin
* @version $Revision: 95482 $
* @since $Date: 2017-09-27 11:50:18 -0700 (Wed, 27 Sep 2017) $
...
";
	...
	*/
	...
	public function updateEventEnddates($params, $db, $check_only = false)
	{
		...
		{
			$caseSql .= "\t\t\t\tWHEN " . intval($__data['nodeid']) . " THEN '" . intval($__data['eventenddate']) . "' \n";
