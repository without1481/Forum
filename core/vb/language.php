...
class vB_Language
{
	...
	protected static function fetchLanguageFieldsSql($addtable = true)
	{
		...
		$sql .= ",
			...
			{$prefix}eventdateformatoverride AS lang_eventdateformatoverride,
			{$prefix}pickerdateformatoverride AS lang_pickerdateformatoverride,
