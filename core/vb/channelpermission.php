 ...
 *  *
 * @version $Revision: 93291 $
 * @since $Date: 2017-03-08 17:14:32 -0800 (Wed, 08 Mar 2017) $
...
//			'canbanusers',
	...
	protected static $permissionPhrases = array(
		'forumpermissions'     => 'channel_permissions_gcppermission',
		'forumpermissions2'    => 'channel_permissions_gcppermission',
	...
	public function fetchPermById($permissionid)
	{
		...
		$qryResult = vB::getDbAssertor()->assertQuery('vBForum:permission', array(
			vB_dB_Query::TYPE_KEY => vB_dB_Query::QUERY_SELECT,
