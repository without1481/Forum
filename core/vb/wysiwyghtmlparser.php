...
class vB_WysiwygHtmlParser
{
	...
	*/
	...
	{
		$result = $this->translateSmilieIdText($matches[1]);
		if($result !== false)
		{
			return $result;
		}
...
//				$strreplace[] = $smilie['smilietext'];
	...
	*/
	...
	{
		/*
		// Removing this code, as it was causing VBV-17048 without any apparent benefit.
