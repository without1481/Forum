	...
	***/
	...
	public static function getQuery($queryid, $params, &$db, $userinfo, $dbtype, $dbSlave)
	{
		...
		if (isset($class_prefix))
		{
			...
			{
				//if we hit this its likely a lot of stuff isn't working.  So the
				//error is deliberately unphrased.
				throw new Exception('Query class ' . $classname . ' not found');
			}
		}
		else
		{
