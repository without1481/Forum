...
class vB_Session_Api extends vB_Session
{
	...
	protected function fetch_session($userid = 0)
	{
		...
		if ($this->apiclient['apiclientid'])
		{
			...
			$this->dBAssertor->update('apiclient', array('apiaccesstoken' => $accesstoken, 'lastactivity' => vB::getRequest()->getTimeNow()), array('apiclientid' => $session['apiclientid']));
		}
