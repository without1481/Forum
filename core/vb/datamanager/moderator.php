...
* @date		$Date: 2016-07-28 16:20:28 -0700 (Thu, 28 Jul 2016) $
*/
class vB_DataManager_Moderator extends vB_DataManager
{
	...
	*/
	function post_save_each($doquery = true)
	{
		...
		if (!$this->condition AND !in_array($this->moderator['userid'], explode(',', $this->config['SpecialUsers']['undeletableusers'])) AND vB::getUserContext()->hasAdminPermission('canadminusers'))
		{
