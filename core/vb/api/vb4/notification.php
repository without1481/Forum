...
class vB_Api_Vb4_notification extends vB_Api
{
	...
	private function getReports($perpage, $pagenumber)
	{
		...
		{
			/*
				Since we can't currently filter or sort by closed, we're turning the absolute total count.
				This is different than in the message center, where we return only the "Open" count.
			 */
