	...
	*/
	...
	protected function verify_files()
	{
		...
		if ($handle)
		{
			...
			$md5_sum_versions = array('vbulletin' => '5.3.4');
			...
			while ($file = readdir($handle))
			{
				if (preg_match('#^md5_sums_.+$#siU', $file, $match))
				{
					...
					//loads the $md5_sums array from the file generated on download.
			...
			{
				$this->startup_warnings[] = $this->phrase['core']['unable_to_read_md5_sums'];
			}
